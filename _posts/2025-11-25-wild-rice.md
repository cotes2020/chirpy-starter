...
{% include embed/image.html src="KEW_POW_Z_palustris.jpg" caption="Zizania palustris type specimen" aspect=".74" %}
{% include embed/image.html src="Kew_POW_Z_palustris_dist.png" caption="Global distribution of Zizania palustris" aspect="3.5" %}
