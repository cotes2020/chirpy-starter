...
{% include embed/image.html id="img1" src="margaret-mee-portraits-of-plants.jpg" aspect="0.72" %}
...
{% include embed/image.html src="eight_families_order_Zingiberales-gigapixel-standard-scale-2_00x.jpg" aspect="1.3" %}
{% include embed/image.html src="map_heliconia_distribution_native_SA_SP.jpg" aspect="1.98" %}
...
{% include embed/image.html src="margaret-mee-portraits-of-plants_1.jpg" aspect="0.72" %}
...
{% include embed/image.html src="bhl-469080.jpg" aspect="0.61" %}
...
{% include embed/image.html src="mee_heliconia_uaupensis_RoyalBotanicGardenKew.jpg" aspect="0.8" %}
...
{% include embed/image.html src="heliconia_Kress_and_team_with_heliconia_DO-standard-scale-2_00x-gigapixel.jpg" aspect="1.43" %}
...
{% include embed/image.html manifest="variouscontrivan1886darw_0053" caption="Charles Darwin, The various contrivances by which orchids are fertilised by insects, page 31, New York, Appleton,1886, Harold B. Lee Library. Harold B. Lee Library, Brigham Young University via archive.org, Not in copyright." aspect="0.60" %}
{% include embed/image.html src="wc:NHM_Xanthopan_morgani.jpg" aspect="0.73" %}
{% include embed/image.html src="margaret-mee-portraits-of-plants_2.jpg" aspect="0.57" %}
...
{% include embed/image.html id="img3" src="margaret-mee-portraits-of-plants_3.jpg" aspect="0.77" %}
...
{% include embed/image.html src="margaret-mee-portraits-of-plants_4.jpg" aspect="0.77" %}
