...
description: Vermeer’s *Girl with a Pearl Earring* once featured a rich indigo background,
  now faded with time—along with the memory of the dye’s colonial origins. This story
  uncovers the global history of indigo, linking its artistic and agricultural uses
  to the exploitation that fueled its trade, while also highlighting its enduring
